# 1 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s10_udpplatformqueries\\\\combined_KAAS_S10_UDPPlatformQueries.c"
...
# 1 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s10_udpplatformqueries\\\\combined_KAAS_S10_UDPPlatformQueries.c" 2
...
# 2 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s10_udpplatformqueries\\\\combined_KAAS_S10_UDPPlatformQueries.c" 2
...
# 3 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s10_udpplatformqueries\\\\combined_KAAS_S10_UDPPlatformQueries.c" 2
...
# 4 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s10_udpplatformqueries\\\\combined_KAAS_S10_UDPPlatformQueries.c" 2

# 1 "UDP_PlatformProductQuery.c" 1
UDP_PlatformProductQuery()
{
	...
	{
		lr_end_transaction("KAAS_T021_UDP_PlatformProductQuery", 1);

	}
	else
	{
		lr_end_transaction("KAAS_T021_UDP_PlatformProductQuery", 0);
...
# 5 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s10_udpplatformqueries\\\\combined_KAAS_S10_UDPPlatformQueries.c" 2

# 1 "UDP_PlatformContentQueries.c" 1
UDP_PlatformContentQueries()
{
	...
	web_submit_data("web_submit_data",
		...
		if(strcmp(lr_eval_string("{Text_count}"),"0")==0)
		{
		lr_end_transaction("KAAS_T022_UDP_PlatformContentQuery", 1);

	}
	else
	{
		lr_end_transaction("KAAS_T022_UDP_PlatformContentQuery", 0);
...
# 6 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s10_udpplatformqueries\\\\combined_KAAS_S10_UDPPlatformQueries.c" 2
...
# 7 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s10_udpplatformqueries\\\\combined_KAAS_S10_UDPPlatformQueries.c" 2
