# 1 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s14_contentenabler\\\\combined_KAAS_S14_ContentEnabler.c"
...
# 1 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s14_contentenabler\\\\combined_KAAS_S14_ContentEnabler.c" 2
...
# 2 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s14_contentenabler\\\\combined_KAAS_S14_ContentEnabler.c" 2
...
# 3 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s14_contentenabler\\\\combined_KAAS_S14_ContentEnabler.c" 2
...
# 4 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s14_contentenabler\\\\combined_KAAS_S14_ContentEnabler.c" 2

# 1 "ContentEnabler.c" 1
ContentEnabler()
{
	...
	if(strcmp(lr_eval_string("{Text_count}"),"0")==0)
	{
		...
		lr_end_transaction("KAAS_T033_ContentEnabler_ExpandProduct", 1);
   
	}
    else
    {
        lr_end_transaction("KAAS_T033_ContentEnabler_ExpandProduct", 0);
    }
...
# 5 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s14_contentenabler\\\\combined_KAAS_S14_ContentEnabler.c" 2

# 1 "Render_FormatAdaptiveCard.c" 1
Render_FormatAdaptiveCard()
{
	...
	if(strcmp(lr_eval_string("{Text_count}"),"0")==0)
	{
		...
		lr_end_transaction("KAAS_T034_Render_Format_AdaptiveCard", 1);
   
	}
    else
    {
        lr_end_transaction("KAAS_T034_Render_Format_AdaptiveCard", 0);
    }
	 
	
	return 0;
}
# 6 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s14_contentenabler\\\\combined_KAAS_S14_ContentEnabler.c" 2

# 1 "GoogleBot_RenderCall.c" 1
GoogleBot_RenderCall()
{
	...
	if(strcmp(lr_eval_string("{Text_count}"),"0")==0)
	{
		...
		lr_end_transaction("KAAS_T035_GoogleBot_RenderCall", 1);
   
	}
    else
    {
        lr_end_transaction("KAAS_T035_GoogleBot_RenderCall", 0);
    }
...
# 7 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s14_contentenabler\\\\combined_KAAS_S14_ContentEnabler.c" 2
...
# 8 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s14_contentenabler\\\\combined_KAAS_S14_ContentEnabler.c" 2
