DocSearchHPES_FindMyProduct()
{
    ...
    {
        lr_end_transaction("KAAS_T017_DocSearchHPES_FindMyProduct_20", LR_FAIL);

    }
    else
    {
        lr_end_transaction("KAAS_T017_DocSearchHPES_FindMyProduct_20", LR_PASS);

    }
    
	//lr_end_transaction("KAAS_T017_DocSearchHPES_FindMyProduct_20",LR_AUTO);
	return 0;
}
