ProductInfoAggregation()
{
	...
	{
		lr_end_transaction("KAAS_T031_ProductInfoAggregation", LR_FAIL);

	}
	else
	{
		lr_end_transaction("KAAS_T031_ProductInfoAggregation", LR_PASS);

	}
	
	//lr_end_transaction("KAAS_T031_ProductInfoAggregation", LR_AUTO);
