Advisory_PDP()
{
	...
	{
		lr_end_transaction("KAAS_T027_Advisory_PDP", LR_FAIL);

	}
	else
	{
		lr_end_transaction("KAAS_T027_Advisory_PDP", LR_PASS);

	}
	//lr_end_transaction("KAAS_T027_Advisory_PDP", LR_AUTO);
