ProductInfo_PDP()
{
	...
	lr_start_transaction("KAAS_T025_ProductInfo_PDP");
	...
	{
		lr_end_transaction("KAAS_T025_ProductInfo_PDP", LR_FAIL);

	}
	else
	{
		lr_end_transaction("KAAS_T025_ProductInfo_PDP", LR_PASS);

	}
	
	//lr_end_transaction("KAAS_T025_ProductInfo_PDP", LR_AUTO);
