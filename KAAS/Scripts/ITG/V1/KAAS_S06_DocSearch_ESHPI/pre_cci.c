# 1 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s06_docsearch_eshpi\\\\combined_KAAS_S06_DocSearch_ESHPI.c"
...
# 1 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s06_docsearch_eshpi\\\\combined_KAAS_S06_DocSearch_ESHPI.c" 2
...
# 2 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s06_docsearch_eshpi\\\\combined_KAAS_S06_DocSearch_ESHPI.c" 2
...
# 3 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s06_docsearch_eshpi\\\\combined_KAAS_S06_DocSearch_ESHPI.c" 2
...
# 4 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s06_docsearch_eshpi\\\\combined_KAAS_S06_DocSearch_ESHPI.c" 2

# 1 "kaas_DocSearchHPES_Doc_with_Products.c" 1
kaas_DocSearchHPES_Doc_with_Products()
{
	...
	{
		lr_end_transaction("KAAS_T014_HPES_Doc_with_Products",1);
		return 0;
	}
	else
	{
		lr_end_transaction("KAAS_T014_HPES_Doc_with_Products",0);
		return 0;
	}
	
 
}
# 5 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s06_docsearch_eshpi\\\\combined_KAAS_S06_DocSearch_ESHPI.c" 2

# 1 "kaas_DocSearchHPES_Doc_Categories.c" 1
kaas_DocSearchHPES_Doc_Categories()
{
	...
	if (strcmp(lr_eval_string("{Text_count}"), "0") == 0)
	{
		lr_end_transaction("KAAS_T015_DocSearchHPES_Doc_Categories",1);
		return 0;
	}
	else
	{
		lr_end_transaction("KAAS_T015_DocSearchHPES_Doc_Categories",0);
		return 0;
	}
...
# 6 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s06_docsearch_eshpi\\\\combined_KAAS_S06_DocSearch_ESHPI.c" 2

# 1 "kaas_DocSearchHPES_Doc_without_Products.c" 1
kaas_DocSearchHPES_Doc_without_Products()
{
	lr_save_string(lr_eval_string("{cp_WISEAccessToken}"), "WISEAccessToken");
	...
	lr_start_transaction("KAAS_T016_DocSearchHPES_Doc_without_Products");	
	
	web_custom_request("web_custom_request",
		"URL=https://hx9ekpvvbi.execute-api.us-east-1.amazonaws.com/KaaS-ITG/v2/search?q={p_DocWithoutProduct}&resultLimit=10&resultStart=0&countryCode={p_countryCode}&languageCode=en&disclosureLevel=696531864679532034919979251200881&printFields=documentID,title,documenttype,renderlink,matchscore,description,contentupdatedate,language,disclosurelevel,store,docsource,documenttypedetails,topics,categorizations&store=docstore,manualstore,supportagentstore,manualagentstore,processagentstore,videostore,udp-content-default,sdlmanualstore&marginPercentage=65&cssMax=100&marginCssPercentage=23&compoundSearch=true&promotions=true",
		"Method=GET",
		"TargetFrame=",
		"Resource=0",
		"Referer=",
	...
	if (strcmp(lr_eval_string("{Text_count}"), "0") == 0)
	{
		lr_end_transaction("KAAS_T016_DocSearchHPES_Doc_without_Products",1);
		return 0;
	}
	else
	{
		lr_end_transaction("KAAS_T016_DocSearchHPES_Doc_without_Products",0);
		return 0;
	}
...
# 7 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s06_docsearch_eshpi\\\\combined_KAAS_S06_DocSearch_ESHPI.c" 2
...
# 8 "e:\\performance\\css\\fy21\\kaas\\scripts\\itg\\v1\\kaas_s06_docsearch_eshpi\\\\combined_KAAS_S06_DocSearch_ESHPI.c" 2
